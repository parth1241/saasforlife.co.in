    ...
    <div className="min-h-screen bg-[#0F172A] relative flex items-center justify-center p-6 text-white overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-2">Create an account to host and scale your SaaS websites</p>
        </div>
        ...
        <div className="bg-[#1E293B]/70 border border-slate-800/80 p-8 rounded-3xl shadow-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Full Name */}
            <div>
              <label htmlFor="reg-name" className="block text-slate-300 font-semibold text-xs uppercase tracking-wider mb-2">
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-700 bg-[#0F172A] text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                  required
                />
              </div>
            </div>
            ...
            {/* Email */}
            <div>
              <label htmlFor="reg-email" className="block text-slate-300 font-semibold text-xs uppercase tracking-wider mb-2">
                Email Address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
            ...
            {/* Password */}
            <div>
              <label htmlFor="reg-password" className="block text-slate-300 font-semibold text-xs uppercase tracking-wider mb-2">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="reg-confirm" className="block text-slate-300 font-semibold text-xs uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm transition-all duration-300 shadow-lg shadow-blue-500/20 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 pt-3"
            >
